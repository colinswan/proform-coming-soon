  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(1200px 600px at 50% 0%, rgba(255,255,255,0.04), transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 grid h-[100dvh] grid-rows-[auto,1fr,auto] px-5">
        ...
        <main className="mx-auto flex w-full max-w-4xl flex-col items-center justify-center gap-6 text-center sm:gap-7">
          ...
          >
            Premium Cladding.
            <span className="block" style={{ color: "#F4FEEB" }}>
          ...
          <div className="w-full max-w-2xl">
            <div
              ...
              style={{ color: "rgba(227,255,204,0.8)" }}
            >
            ...
            <div
              ...
              style={{ backgroundColor: "rgba(179,179,179,0.3)" }}
            >
              <div
            ...
            <p
              ...
              style={{ color: "rgba(227,255,204,0.7)" }}
            >
...
function Tile({ label, value }: { label: string; value: number }) {
  ...
  return (
    <div
      className="rounded-lg border p-3 shadow-sm backdrop-blur-sm sm:p-4"
      style={{
        backgroundColor: "rgba(255,255,255,0.06)",
        borderColor: "rgba(227,255,204,0.2)",
      }}
    >
      <div
